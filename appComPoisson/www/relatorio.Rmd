...
Este documento foi produzido interativamente via interface web atráves
...
sistema de versionamento Git e está disponível _on-line_ atráves do
...
modelo _COM-Poisson_ é que ele tem como caso paraticular a própria
distribuição _Poisson_, quando o parâmetro $\nu$ é fixado em 1.

Com isso podemos avaliar a fuga da suposição de equidispersão atráves de
